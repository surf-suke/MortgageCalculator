    ...
    public class TitleTextViwOnClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            if (v.getId() == typeOneText.getId()){
                typeOneText.setTextColor(Color.WHITE);
                typeTwoText.setTextColor(Color.BLACK);
                typeOneText.setBackgroundResource(R.drawable.shape);
                typeTwoText.setBackgroundResource(0);
            }
            if (v.getId() == typeTwoText.getId()){
                typeOneText.setTextColor(Color.BLACK);
                typeTwoText.setTextColor(Color.WHITE);
                typeTwoText.setBackgroundResource(R.drawable.shape);
                typeOneText.setBackgroundResource(0);
            }
